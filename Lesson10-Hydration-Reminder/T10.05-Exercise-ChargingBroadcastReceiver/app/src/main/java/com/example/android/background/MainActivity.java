...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mIntentFiler.addAction(Intent.ACTION_POWER_CONNECTED);
        mIntentFiler.addAction(Intent.ACTION_POWER_DISCONNECTED);
    }
    ...
    protected void onResume() {
        super.onResume();
        registerReceiver(mChargingBroadcastReceiver, mIntentFiler);
    }
